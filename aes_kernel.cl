...
__kernel void AES_ECB_Encrypt(__global uint *src,__global uint *dest,__global uint* key,
...
__kernel void AES_ECB_Decrypt(__global uint *src,__global uint *dest,__global uint* key,
__local uint *keyround,__local uint *s_T)
{
	int iloc = get_local_id(0);
	int igroup = get_group_id(0);
	int id = get_global_id(0);
	__local uint DecryData[1024];
	__local uchar InvBox[256];
	InvBox[iloc] = InvS[iloc];
	if(iloc < 44)
		keyround[iloc] = key[iloc];
	for(uint i =0;i < 4; ++i){ 
		s_T[iloc*4 + i] = DecryptT[iloc*4 + i];
		DecryData[iloc*4 + i] = src[id*4 + i];
	}
	barrier(CLK_LOCAL_MEM_FENCE);
	uint s0,s1,s2,s3,t0,t1,t2,t3;
	uint index0 = iloc*4;
	...
	s0 = DecryData[index0] ^ keyround[0];
	s1 = DecryData[index1] ^ keyround[1];
	s2 = DecryData[index2] ^ keyround[2];
	s3 = DecryData[index3] ^ keyround[3];

	// round 1
	t0 = s_T[(s0 & 0xff)]^s_T[((s3 >> 8) & 0xff) + 256]^s_T[((s2 >> 16) & 0xff) + 512]^s_T[((s1 >> 24)& 0xff) + 768] ^ keyround[4];
	t1 = s_T[(s1 & 0xff)]^s_T[((s0 >> 8) & 0xff) + 256]^s_T[((s3 >> 16) & 0xff) + 512]^s_T[((s2 >> 24) & 0xff) + 768] ^ keyround[5];
	t2 = s_T[(s2 & 0xff)]^s_T[((s1 >> 8) & 0xff) + 256]^s_T[((s0 >> 16) & 0xff) + 512]^s_T[((s3 >> 24) & 0xff) + 768] ^ keyround[6];
	t3 = s_T[(s3 & 0xff)]^s_T[((s2 >> 8) & 0xff) + 256]^s_T[((s1 >> 16) & 0xff) + 512]^s_T[((s0 >> 24) & 0xff) + 768] ^ keyround[7];
	//round2
	s0 = s_T[(t0 & 0xff)]^s_T[((t3 >> 8) & 0xff) + 256]^s_T[((t2 >> 16) & 0xff) + 512]^s_T[((t1 >> 24)& 0xff) + 768] ^ keyround[8];
	s1 = s_T[(t1 & 0xff)]^s_T[((t0 >> 8) & 0xff) + 256]^s_T[((t3 >> 16) & 0xff) + 512]^s_T[((t2 >> 24) & 0xff) + 768] ^ keyround[9];
	s2 = s_T[(t2 & 0xff)]^s_T[((t1 >> 8) & 0xff) + 256]^s_T[((t0 >> 16) & 0xff) + 512]^s_T[((t3 >> 24) & 0xff) + 768] ^ keyround[10];
	s3 = s_T[(t3 & 0xff)]^s_T[((t2 >> 8) & 0xff) + 256]^s_T[((t1 >> 16) & 0xff) + 512]^s_T[((t0 >> 24) & 0xff) + 768] ^ keyround[11];
	//round3
	t0 = s_T[(s0 & 0xff)]^s_T[((s3 >> 8) & 0xff) + 256]^s_T[((s2 >> 16) & 0xff) + 512]^s_T[((s1 >> 24)& 0xff) + 768] ^ keyround[12];
	t1 = s_T[(s1 & 0xff)]^s_T[((s0 >> 8) & 0xff) + 256]^s_T[((s3 >> 16) & 0xff) + 512]^s_T[((s2 >> 24) & 0xff) + 768] ^ keyround[13];
	t2 = s_T[(s2 & 0xff)]^s_T[((s1 >> 8) & 0xff) + 256]^s_T[((s0 >> 16) & 0xff) + 512]^s_T[((s3 >> 24) & 0xff) + 768] ^ keyround[14];
	t3 = s_T[(s3 & 0xff)]^s_T[((s2 >> 8) & 0xff) + 256]^s_T[((s1 >> 16) & 0xff) + 512]^s_T[((s0 >> 24) & 0xff) + 768] ^ keyround[15];
	//round4
	s0 = s_T[(t0 & 0xff)]^s_T[((t3 >> 8) & 0xff) + 256]^s_T[((t2 >> 16) & 0xff) + 512]^s_T[((t1 >> 24)& 0xff) + 768] ^ keyround[16];
	s1 = s_T[(t1 & 0xff)]^s_T[((t0 >> 8) & 0xff) + 256]^s_T[((t3 >> 16) & 0xff) + 512]^s_T[((t2 >> 24) & 0xff) + 768] ^ keyround[17];
	s2 = s_T[(t2 & 0xff)]^s_T[((t1 >> 8) & 0xff) + 256]^s_T[((t0 >> 16) & 0xff) + 512]^s_T[((t3 >> 24) & 0xff) + 768] ^ keyround[18];
	s3 = s_T[(t3 & 0xff)]^s_T[((t2 >> 8) & 0xff) + 256]^s_T[((t1 >> 16) & 0xff) + 512]^s_T[((t0 >> 24) & 0xff) + 768] ^ keyround[19];
	//round5
	t0 = s_T[(s0 & 0xff)]^s_T[((s3 >> 8) & 0xff) + 256]^s_T[((s2 >> 16) & 0xff) + 512]^s_T[((s1 >> 24)& 0xff) + 768] ^ keyround[20];
	t1 = s_T[(s1 & 0xff)]^s_T[((s0 >> 8) & 0xff) + 256]^s_T[((s3 >> 16) & 0xff) + 512]^s_T[((s2 >> 24) & 0xff) + 768] ^ keyround[21];
	t2 = s_T[(s2 & 0xff)]^s_T[((s1 >> 8) & 0xff) + 256]^s_T[((s0 >> 16) & 0xff) + 512]^s_T[((s3 >> 24) & 0xff) + 768] ^ keyround[22];
	t3 = s_T[(s3 & 0xff)]^s_T[((s2 >> 8) & 0xff) + 256]^s_T[((s1 >> 16) & 0xff) + 512]^s_T[((s0 >> 24) & 0xff) + 768] ^ keyround[23];
	//round6
	s0 = s_T[(t0 & 0xff)]^s_T[((t3 >> 8) & 0xff) + 256]^s_T[((t2 >> 16) & 0xff) + 512]^s_T[((t1 >> 24)& 0xff) + 768] ^ keyround[24];
	s1 = s_T[(t1 & 0xff)]^s_T[((t0 >> 8) & 0xff) + 256]^s_T[((t3 >> 16) & 0xff) + 512]^s_T[((t2 >> 24) & 0xff) + 768] ^ keyround[25];
	s2 = s_T[(t2 & 0xff)]^s_T[((t1 >> 8) & 0xff) + 256]^s_T[((t0 >> 16) & 0xff) + 512]^s_T[((t3 >> 24) & 0xff) + 768] ^ keyround[26];
	s3 = s_T[(t3 & 0xff)]^s_T[((t2 >> 8) & 0xff) + 256]^s_T[((t1 >> 16) & 0xff) + 512]^s_T[((t0 >> 24) & 0xff) + 768] ^ keyround[27];
	//round7
	t0 = s_T[(s0 & 0xff)]^s_T[((s3 >> 8) & 0xff) + 256]^s_T[((s2 >> 16) & 0xff) + 512]^s_T[((s1 >> 24)& 0xff) + 768] ^ keyround[28];
	t1 = s_T[(s1 & 0xff)]^s_T[((s0 >> 8) & 0xff) + 256]^s_T[((s3 >> 16) & 0xff) + 512]^s_T[((s2 >> 24) & 0xff) + 768] ^ keyround[29];
	t2 = s_T[(s2 & 0xff)]^s_T[((s1 >> 8) & 0xff) + 256]^s_T[((s0 >> 16) & 0xff) + 512]^s_T[((s3 >> 24) & 0xff) + 768] ^ keyround[30];
	t3 = s_T[(s3 & 0xff)]^s_T[((s2 >> 8) & 0xff) + 256]^s_T[((s1 >> 16) & 0xff) + 512]^s_T[((s0 >> 24) & 0xff) + 768] ^ keyround[31];
	//round8
	s0 = s_T[(t0 & 0xff)]^s_T[((t3 >> 8) & 0xff) + 256]^s_T[((t2 >> 16) & 0xff) + 512]^s_T[((t1 >> 24)& 0xff) + 768] ^ keyround[32];
	s1 = s_T[(t1 & 0xff)]^s_T[((t0 >> 8) & 0xff) + 256]^s_T[((t3 >> 16) & 0xff) + 512]^s_T[((t2 >> 24) & 0xff) + 768] ^ keyround[33];
	s2 = s_T[(t2 & 0xff)]^s_T[((t1 >> 8) & 0xff) + 256]^s_T[((t0 >> 16) & 0xff) + 512]^s_T[((t3 >> 24) & 0xff) + 768] ^ keyround[34];
	s3 = s_T[(t3 & 0xff)]^s_T[((t2 >> 8) & 0xff) + 256]^s_T[((t1 >> 16) & 0xff) + 512]^s_T[((t0 >> 24) & 0xff) + 768] ^ keyround[35];
	//round9
	t0 = s_T[(s0 & 0xff)]^s_T[((s3 >> 8) & 0xff) + 256]^s_T[((s2 >> 16) & 0xff) + 512]^s_T[((s1 >> 24)& 0xff) + 768] ^ keyround[36];
	t1 = s_T[(s1 & 0xff)]^s_T[((s0 >> 8) & 0xff) + 256]^s_T[((s3 >> 16) & 0xff) + 512]^s_T[((s2 >> 24) & 0xff) + 768] ^ keyround[37];
	t2 = s_T[(s2 & 0xff)]^s_T[((s1 >> 8) & 0xff) + 256]^s_T[((s0 >> 16) & 0xff) + 512]^s_T[((s3 >> 24) & 0xff) + 768] ^ keyround[38];
	t3 = s_T[(s3 & 0xff)]^s_T[((s2 >> 8) & 0xff) + 256]^s_T[((s1 >> 16) & 0xff) + 512]^s_T[((s0 >> 24) & 0xff) + 768] ^ keyround[39];
	//round10
	s0 = ((uint)InvBox[(t0 & 0xff)]) ^
		 ((uint)InvBox[(t3 >> 8) & 0xff] << 8) ^
		 ((uint)InvBox[(t2 >> 16) & 0xff] << 16) ^
	 	 ((uint)InvBox[(t1 >> 24) & 0xff] << 24) ^
		 keyround[40];
	s1 = ((uint)InvBox[(t1 & 0xff)]) ^
		 ((uint)InvBox[(t0 >> 8) & 0xff] << 8) ^
		 ((uint)InvBox[(t3 >> 16) & 0xff] << 16) ^
	 	 ((uint)InvBox[(t2 >> 24) & 0xff] << 24) ^
		 keyround[41];
	s2 = ((uint)InvBox[(t2 & 0xff)]) ^
		 ((uint)InvBox[(t1 >> 8) & 0xff] << 8) ^
		 ((uint)InvBox[(t0 >> 16) & 0xff] << 16) ^
	 	 ((uint)InvBox[(t3 >> 24) & 0xff] << 24) ^
		 keyround[42];
	s3 = ((uint)InvBox[(t3 & 0xff)]) ^
		 ((uint)InvBox[(t2 >> 8) & 0xff] << 8) ^
		 ((uint)InvBox[(t1 >> 16) & 0xff] << 16) ^
	 	 ((uint)InvBox[(t0 >> 24) & 0xff] << 24) ^
		 keyround[43];
